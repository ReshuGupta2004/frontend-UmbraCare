...
const Notifications = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const response = await axios.get('https://backend-umbracare.onrender.com/api/notifications', {
        headers: {
          'x-auth-token': token,
        },
      });
  ...
  const markAsRead = async (id) => {
    try {
      ...
      await axios.put(`https://backend-umbracare.onrender.com/api/notifications/${id}/read`, {}, {
        headers: {
          'x-auth-token': token,
        },
      });
