...
const PeriodTracker = () => {
  ...
  const fetchPeriodEntries = async () => {
    try {
      ...
      const response = await axios.get('https://backend-umbracare.onrender.com/api/period-tracker', {
        headers: {
          'x-auth-token': token,
        },
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editMode && currentEntryId) {
        await axios.put(`https://backend-umbracare.onrender.com/api/period-tracker/${currentEntryId}`, periodData, {
          headers: {
            'x-auth-token': token,
        ...
        await axios.post('https://backend-umbracare.onrender.com/api/period-tracker', periodData, {
          headers: {
            'x-auth-token': token,
            'Content-Type': 'application/json'
          }
  ...
  const handleDelete = async (id) => {
    try {
      ...
      await axios.delete(`https://backend-umbracare.onrender.com/api/period-tracker/${id}`, {
        headers: {
          'x-auth-token': token,
        },
      });
